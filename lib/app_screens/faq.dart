                                  ...
                                  children: [
                                    Container(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            'Do you take specifc measures for COVID-19?',
                                            style: TextStyle(
                                              color: barColor,
                                              fontSize: 25,
                                              fontFamily: 'Oswald',
                                          ...
                                          Container(height: 20,),
                                          Text(
                                            'Absolutely. All our experts have been vacinated and the entire workspace is santized regularly. All the necessary precautions and employed and client appointments have been set to 50% for safety.',
                                            style: TextStyle(
                                              fontSize: 20,
                                              fontFamily: 'Oswald',
                                              fontWeight: FontWeight.normal
                                    ...
                                    Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Container(height: 20,),
                                          Text(
                                            'We provide servcies for age 4+ . We have specialist for kids who enjoy styling them up.',
                                            style: TextStyle(
                                              fontSize: 20,
                                              fontFamily: 'Oswald',
                                              fontWeight: FontWeight.normal
                                    ...
                                    Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Container(height: 20,),
                                          Text(
                                            'Yes. We have wide front door capable of electric wheelchairs with a ramp and customized handicap section.',
                                            style: TextStyle(
                                              fontSize: 20,
                                              fontFamily: 'Oswald',
                                              fontWeight: FontWeight.normal
